...
public class MatriculaController {
	...
	public String registrarMatricula(String cedula, String codigo) {
		
		this.matriculaService.registrarMatricula(cedula, codigo);
	...
	public String reporteMatriculas(Model model, String cedula, String nombreEstudiante, String apellido, 
									String nombreMateria, String codigo) {
		
		List<MatriculaDTO> lista = this.matriculaService.reporteMatriculas(cedula, nombreEstudiante, apellido, nombreMateria, codigo);
